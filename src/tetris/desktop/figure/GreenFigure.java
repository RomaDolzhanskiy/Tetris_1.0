...
/**
 * Обект GreenFigure, одна из семи основных фигур игры. Наследуется от Figure.
 */
public class GreenFigure extends Figure {

    /**
     * Иконка для кубиков фигуры зеленого цвета.
     */
    private ImageIcon icon = new ImageIcon("src\\image\\Green.jpg");
    ...
    public void createFigure(JLabel label) {
        ...
        square3.setLocation(150, 30);
        square3.setSize(30, 30);
        label.add(square3);

        square4.setLocation(150, 60);
