 ...
 */
public class PurpleFigure extends Figure {

    /**
     * Иконка для кубиков фигуры пурпурного цвета.
     */
    private ImageIcon icon = new ImageIcon("src\\image\\Purple.jpg");
