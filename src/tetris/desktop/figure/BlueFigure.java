...
/**
 * Обект BlueFigure, одна из семи основных фигур игры. Наследуется от Figure.
 */
public class BlueFigure extends Figure {

    /**
     * Иконка для кубиков фигуры синего цвета.
     */
    private ImageIcon icon = new ImageIcon("src\\image\\Blue.jpg");
